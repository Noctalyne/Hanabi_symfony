 ...
 */
final class Version20231010103341 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clients (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(50) NOT NULL, user_role JSON NOT NULL, username VARCHAR(50) NOT NULL, user_password VARCHAR(60) NOT NULL, nom_client VARCHAR(50) DEFAULT NULL, prenom_client VARCHAR(50) DEFAULT NULL, num_telephone VARCHAR(10) DEFAULT NULL, UNIQUE INDEX UNIQ_C82E74E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE clients ADD CONSTRAINT FK_C82E74E7927C74 FOREIGN KEY (email) REFERENCES user (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE clients DROP FOREIGN KEY FK_C82E74E7927C74');
