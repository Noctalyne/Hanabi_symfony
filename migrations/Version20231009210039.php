 ...
 */
final class Version20231009210039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clients (id INT AUTO_INCREMENT NOT NULL, user_role JSON NOT NULL, userEmail VARCHAR(50) NOT NULL, username VARCHAR(50) NOT NULL, user_password VARCHAR(60) NOT NULL, nom_client VARCHAR(50) DEFAULT NULL, prenom_client VARCHAR(50) DEFAULT NULL, num_telephone VARCHAR(10) DEFAULT NULL, UNIQUE INDEX UNIQ_C82E741F76FA2 (userEmail), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_role JSON NOT NULL, userEmail VARCHAR(50) NOT NULL, username VARCHAR(50) NOT NULL, user_password VARCHAR(60) NOT NULL, UNIQUE INDEX UNIQ_8D93D6491F76FA2 (userEmail), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vendeurs (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, email_user_id INT NOT NULL, user_role JSON NOT NULL, userEmail VARCHAR(50) NOT NULL, username VARCHAR(50) NOT NULL, user_password VARCHAR(60) NOT NULL, UNIQUE INDEX UNIQ_2180DE31F76FA2 (userEmail), UNIQUE INDEX UNIQ_2180DE379F37AE5 (id_user_id), UNIQUE INDEX UNIQ_2180DE31AAEBB5A (email_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
